...
export class FirestoreInitService {
	...
	async resetTasksInitialization(): Promise<void> {
		...
		console.log(
			"[FirestoreInit] Tasks initialization flag reset - tasks will re-initialize on next load",
		);
	}
	...
	async resetContactsInitialization(): Promise<void> {
		...
		console.log(
			"[FirestoreInit] Contacts initialization flag reset - contacts will re-initialize on next load",
		);
	}
}
